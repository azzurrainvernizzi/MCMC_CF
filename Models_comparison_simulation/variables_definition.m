...
%% function for BIC and AIC
% RR edit
BIC=@(l,n,k) k*log(n)-2*l; %l: log likelyhood, n number of (independent) points, k number of parameters
AIC=@(l,k) 2*k-2*l; 
model_parameters=2;
% end RR edit
...
n_samples=5000;% number of iterations for MCMC
% to test this code, we set it to #100.
%how_beta=0; % how_beta=0 for bCF option A,estimate beta using OLS;
